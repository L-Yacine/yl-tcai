...
const CodePage = () => {
  ...
  return (
    <div>
      <Heading
        title="Ghost writer"
        description="Ghost writer can darft emails, video scripts, social media captions ..etc"
        icon="/writer.png"
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="p-0 m-0">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="Write a thirty-second TikTok script for a healthy snack brand."
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
